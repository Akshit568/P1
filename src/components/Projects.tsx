...
import { ExternalLink, Github, Play, Database, Brain, Video, BarChart3, TrendingUp, Palette, Briefcase, Globe, Shield, Building, Gamepad2 } from 'lucide-react';
...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Developed a fully responsive, multipage "Construction Services" site featuring Home, Services, Gallery, Pricing and Contact pages with dynamic animations.',
    ...
    highlights: [
      'Fully responsive multipage construction services website',
      'Dynamic contact form with client-side validation',
      'Interactive hover/carousel animations for portfolio showcase',
      'Optimized for <1s load times with cross-browser compatibility'
    ],
  ...
  {
    id: 4,
    title: 'Titanic Passenger Survival Analysis',
    description: 'Performed end-to-end EDA on Titanic dataset, handling missing values and engineering features to build classification models achieving 83% test accuracy.',
    ...
    highlights: [
      'End-to-end EDA with missing value handling and outlier detection',
      'Feature engineering (Title, FamilySize) from raw passenger data',
      'Compared classification models (Logistic Regression, Random Forest, XGBoost)',
      'Visualized survival patterns by age, gender, and class for insights'
    ],
  ...
  },
  {
    ...
    description: 'Constructed an NLP pipeline to classify news articles, applying advanced text processing and achieving 90%+ accuracy with multiple classifiers.',
    image: 'https://images.pexels.com/photos/518543/pexels-photo-518543.jpeg?auto=compress&cs=tinysrgb&w=800',
    technologies: ['Python', 'NLTK', 'scikit-learn', 'TF-IDF', 'Flask', 'NLP'],
    liveUrl: '#',
    githubUrl: '#',
    featured: false,
    duration: 'Jun 2024 - Jul 2024',
    highlights: [
      'NLP pipeline with tokenization, stop-word removal, and lemmatization',
      'TF-IDF vectorization for feature extraction from text data',
      'Trained classifiers (Naive Bayes, SVM, Logistic Regression) with 90%+ accuracy',
      'Flask API with web UI for real-time headline classification'
    ],
  ...
  },
  {
    ...
    description: 'Architected a console-based banking application with OOP design, supporting account operations and persistent data storage.',
    image: 'https://images.pexels.com/photos/259027/pexels-photo-259027.jpeg?auto=compress&cs=tinysrgb&w=800',
    technologies: ['C++', 'Object-Oriented Design', 'File I/O', 'Data Structures'],
    liveUrl: '#',
    githubUrl: '#',
    featured: false,
    duration: 'Mar 2024 - Apr 2024',
    highlights: [
      'Console-based banking with account creation and transactions',
      'Classes and inheritance for Account, Customer, and Transaction models',
      'File streams for persistent data storage',
      'Input validation reducing invalid operations by 95%'
    ],
  ...
  },
  {
    ...
    description: 'Built the classic Snake arcade game with smooth controls, collision detection, and dynamic difficulty scaling using Pygame.',
    ...
    highlights: [
      ...
      'Collision detection and dynamic difficulty scaling',
      'Scoreboard with persistent high-score tracking',
      'Modular classes (Snake, Food, Game) for extensibility'
    ],
  ...
  {
    id: 10,
    title: 'ATM Simulator (Python)',
    description: 'Developed an ATM simulation with PIN authentication, transaction processing, and CSV-based data persistence.',
    image: 'https://images.pexels.com/photos/164527/pexels-photo-164527.jpeg?auto=compress&cs=tinysrgb&w=800',
    technologies: ['Python', 'Object-Oriented Programming', 'File I/O', 'CSV'],
    liveUrl: '#',
    githubUrl: '#',
    featured: false,
    duration: 'Jan 2024 - Feb 2024',
    highlights: [
      'ATM simulation with PIN authentication system',
      'Balance inquiry, cash withdrawal/deposit, mini-statements',
      'UserAccount and TransactionLog classes with CSV persistence',
      'Enhanced UX with validation preventing overdrafts'
    ],
    icon: <Database className="w-6 h-6" />,
    type: 'project'
  },
